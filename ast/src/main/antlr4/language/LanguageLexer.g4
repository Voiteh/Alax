...
// Because of much work required to make identifiers with spaces and without work, we match then using regular expressions in parser
//
fragment UPPERCASE_IDENTIFIER_PART: UPPERCASE_LETTER SYMBOL* ;
fragment LOWERCASE_IDENTIFIER_PART: LOWERCASE_LETTER SYMBOL* ;
UPPERCASE_IDENTIFIER: UPPERCASE_IDENTIFIER_PART+;
LOWERCASE_IDENTIFIER: LOWERCASE_IDENTIFIER_PART+;
