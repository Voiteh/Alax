 ...
 * @param statements
 */
class CompilationUnit(val statements: Seq[Statement]) extends Container
 ...
 * @param children
 */
class Package(val children: Seq[CompilationUnit | Package]) extends Container
 ...
 */
class Module(val descriptor: Module.Descriptor, val children: Seq[Package]) extends Container
...
class Project(val descriptor: Project.Descriptor, val children: Seq[Module]) extends Container;
