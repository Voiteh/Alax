...
class AstToModelTransformer {
  ...
  object transform {
    def expression(expression: ast.model.Expression): Expression | CompilerError = {
      expression match {
    ...
    object expression {
      def literal(literal: ast.model.Expression.Literal): model.Literal | CompilerError = {
        return literal match {
          case Literal.Character(value, metadata) => Literals.Character(
            value = value
          )
          case Literal.Integer(value, metadata) => compiler.model.Literals.Integer(
            value = value.longValue()
          )
          case Literal.Boolean(value, metadata) => compiler.model.Literals.Boolean(
            value = value
          )
          case Literal.String(value, metadata) => compiler.model.Literals.String(
            value = value
          )
          case Literal.Float(value, metadata) => compiler.model.Literals.Float(
            value = value
          )
        }
      }
    ...
    object `type` {
      def reference(typeReference: ast.model.Partial.Type.Reference, imports: Seq[Import]): model.Declaration.Type | CompilerError = {
      ...
      object reference {
        def value(valueTypeReference: ast.model.Partial.Type.Reference.Value, imports: Seq[Import]): Value.Type | CompilerError = {
    ...
    def trace(location: ast.model.Node.Location): Trace = compiler.base.model.Trace(
      unit = location.unit,
    ...
    def imports(`import`: ast.model.Statement.Declaration.Import, ancestors: Seq[ast.model.Partial.Name.Qualified] = Seq()): Seq[Tracable[Import]] = {
      return `import` match {
