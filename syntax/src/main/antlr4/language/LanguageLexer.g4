...
VALUE_TYPE_NAME: FULLY_QUALIFIED_TYPE_NAME;

fragment FULLY_QUALIFIED_TYPE_NAME:
    (LOWERCASE_LETTER (LOWERCASE_LETTER|UPPERCASE_LETTER|DIGIT|UNDERSCORE)* DOT)+
    UPPERCASE_LETTER  (LOWERCASE_LETTER|UPPERCASE_LETTER|DIGIT|UNDERSCORE)*
    ;
